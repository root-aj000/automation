...
export const account = pgTable(
  ...
  (table) => ({
    ...
    uniqueUserProviderAccount: uniqueIndex(
...
export const workflow = pgTable(
  ...
  (table) => ({
    ...
    //   table.workspaceId
    // ),
    organizationIdIdx : index("workflow_organization_id_idx").on(table.organizationId)
  })
);
...
export const workflowExecutionLogs = pgTable(
  ...
  (table) => ({
    ...
    ).on(table.executionId, table.organizationId),
...
export const workspaceNotificationSubscription = pgTable(
  ...
  (table) => ({
    workspaceIdIdx: index("workspace_notification_workspace_id_idx").on(
      table.workspaceId
    ),
    activeIdx: index("workspace_notification_active_idx").on(table.active),
    typeIdx: index("workspace_notification_type_idx").on(
...
export const workspaceNotificationDelivery = pgTable(
  ...
  (table) => ({
    ...
    statusIdx: index("workspace_notification_delivery_status_idx").on(
      table.status
    ),
    nextAttemptIdx: index(
...
export const templateCreatorTypeEnum = pgEnum("template_creator_type", [
  "user",
  "organization",
]);
...
export const templateCreators = pgTable(
  ...
  (table) => ({
    ...
    referenceIdIdx: index("template_creators_reference_id_idx").on(
      table.referenceId
    ),
...
export const templates = pgTable(
  "templates",
  {
    ...
    tags: text("tags")
      .array()
      .notNull()
      .default(sql`'{}'::text[]`), // Array of tags
  ...
  (table) => ({
    ...
    statusViewsIdx: index("templates_status_views_idx").on(
      table.status,
      table.views
    ),
    statusStarsIdx: index("templates_status_stars_idx").on(
      table.status,
      table.stars
    ),
